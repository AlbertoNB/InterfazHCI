        ...
        <div class="row text-center">
            <div class="col-sm">
                ...
                <ul class="list-unstyled">
                    <li>
                        <a class="link-secondary text-decoration-none" href="https://utm.edu.ec/">
            ...
            <div class="col-sm mb-2">
                <a class="link-secondary text-decoration-none me-2" href="https://www.facebook.com/utmmanabi/" data-placement="top" title="facebook">
...
<!--<script src="../respaldo/hablar5.js"></script>
<script src="../js2/voice_recognition_reading.js"></script>-->
