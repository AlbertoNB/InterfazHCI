...
<main class="space_body content-right">
    <div class="container-md my-3">
        <div class=" mx-0 row d-flex align-items-center p-2 bg-secondary text-light shadow-sm rounded-top mode-dark4">
                ...
                <div class="col pl-1">
                    <div class="d-flex justify-content-between w-100">
                        <h4 class="mb-0 text-small">Estudiante #</h4>
                    </div>
                </div>
                <div class="col-auto p-0">
                    <a class="btn btn-success btn-sm pt-0" href="chat_personal.php" role="button">
        ...
        <!--height: 60vh
            ...
            -->
        <div class="p-2 bg-white shadow-sm mode-dark1 overflow-auto scroll-decor" style="height: calc(100vh - 13rem);">
            <div class="ml-3 text-light mr-2">
                <div class="mb-3">
                    <p class="d-inline p-1 bg-primary rounded-lg">
