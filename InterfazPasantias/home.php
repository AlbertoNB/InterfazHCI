<div class="collapse show" data-parent="#pasantiaVinculacionCont"> <!--id="nav-vinculacion"-->
    <div class="m-2">
        <div id="carouselExampleCaptions" class="carousel slide mb-3" data-ride="carousel">
            ...
            <div class="carousel-inner rounded">
                ...
                <div class="carousel-item">
                    <img src="../img/2.png" class="d-block w-100" alt="..."> <!--height="400px"-->
                    <div class="carousel-caption d-none d-md-block">
                ...
                <div class="carousel-item">
                    <img src="../img/4.png" class="d-block w-100" alt="..."> <!--height="400px"-->
                    <div class="carousel-caption d-none d-md-block">
